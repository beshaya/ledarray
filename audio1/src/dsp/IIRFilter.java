...
public static void main(String[] args){
	IIRFilter myfilter = new IIRFilter();
	myfilter.setPrototype("Butterworth");
	myfilter.setFilterType("HP");
	myfilter.setOrder(2);
	myfilter.setRate(44100);
	myfilter.setFreq1(10000f);
	myfilter.setFreq2(10000f);
	myfilter.design();
	double[] a = myfilter.getACoeff();
	double[] b = myfilter.getBCoeff();
